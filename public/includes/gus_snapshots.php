...
class GusSnapshotRepository
{
    ...
    public function save(array $data): int
    {
        ...
        $stmt->execute([
            ...
            ':report_type' => ($data['report_type'] ?? null) !== null ? (string)$data['report_type'] : null,
            ':http_code' => ($data['http_code'] ?? null) !== null ? (int)$data['http_code'] : null,
            ':ok' => !empty($data['ok']) ? 1 : 0,
            ':error_code' => ($data['error_code'] ?? null) !== null ? (string)$data['error_code'] : null,
            ':error_message' => ($data['error_message'] ?? null) !== null ? (string)$data['error_message'] : null,
            ':fault_code' => ($data['fault_code'] ?? null) !== null ? (string)$data['fault_code'] : null,
            ':fault_string' => ($data['fault_string'] ?? null) !== null ? (string)$data['fault_string'] : null,
            ':raw_request' => ($data['raw_request'] ?? null) !== null ? (string)$data['raw_request'] : null,
            ':raw_response' => ($data['raw_response'] ?? null) !== null ? (string)$data['raw_response'] : null,
            ':raw_parsed' => $rawParsed,
            ':correlation_id' => ($data['correlation_id'] ?? null) !== null ? (string)$data['correlation_id'] : null,
