...
/** @var string $aneks_start_date */
/** @var string $aneks_end_date */
?>
<h2 style="text-align:center;">Aneks terminowy nr <?= htmlspecialchars($docNumber) ?></h2>
...
<p style="margin-top:12px;">
    Strony uzgadniają zmianę terminu obowiązywania umowy reklamowej na okres 12 miesięcy
    od dnia <?= htmlspecialchars($aneks_start_date) ?> do dnia <?= htmlspecialchars($aneks_end_date) ?>.
</p>

<p>
    Klauzula akceptacyjna: podpisanie niniejszego aneksu potwierdza przyjęcie zmian i akceptację
    obowiązywania umowy w nowym terminie.
</p>
