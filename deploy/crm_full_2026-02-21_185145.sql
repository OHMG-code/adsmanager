...
CREATE TABLE `cennik_wywiady` (
  ...
  `data_modyfikacji` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=latin2 COLLATE=latin2_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=latin2 COLLATE=latin2_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(142,19,'LAYMAN SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ SPÓŁKA KOMANDYTOWA',20,'2026-02-22','2026-03-31',0.00,2088.00,0.00,2088.00,2568.24,'2026-02-21 14:27:40',0,NULL,2,'W realizacji',2088.00,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=799 DEFAULT CHARSET=latin2 COLLATE=latin2_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(3,'OHMG SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ','5792268412',NULL,'ceo@ohmg.pl','telefon',NULL,'Oferta wysłana',NULL,'2026-02-19','2026-02-16 20:55:59','2026-02-17 20:57:37',2,'Niski','Follow-up po ofercie','2026-02-19 21:57:37',12,'2026-02-16 22:18:35',2,2,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL),
(5,'5N Justyna Zienkiewicz','5782751414',NULL,NULL,'telefon','Jan Kowalski','Oferta wysłana',NULL,'2026-02-20','2026-02-17 19:50:57','2026-02-18 22:11:28',2,'Niski','Follow-up po ofercie','2026-02-20 23:11:28',NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,'','82-300','Elbląg','ul. Natolińska','46',NULL),
(6,'Adrian Wysocki Wsparcie IT','5782848332',NULL,NULL,'telefon','Jan Kowalski','Wygrana',NULL,NULL,'2026-02-17 19:53:00','2026-02-18 22:11:32',2,'Niski',NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,'','82-300','Elbląg','ul. Natolińska','32',NULL),
(7,'Alpintel Łukasz Binkowski','5782968272',NULL,NULL,'telefon','Jan Kowalski','Przegrana',NULL,NULL,'2026-02-17 19:53:18','2026-02-18 11:37:57',2,'Niski',NULL,NULL,14,'2026-02-18 12:37:57',2,2,NULL,NULL,NULL,NULL,'','82-300','Elbląg','ul. Natolińska','31',NULL),
(8,'OHMG SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ','5792268412',NULL,'ceo@ohmg.pl','telefon','Jan Kowalski','nowy',NULL,NULL,'2026-02-17 22:05:01','2026-02-18 10:37:11',2,'Niski',NULL,NULL,13,'2026-02-18 11:37:11',2,2,NULL,NULL,NULL,NULL,'','82-200','Grobelno',NULL,'8',NULL),
(9,'Firma Handlowo-Usługowa Beata Wojtkiewicz BEATA SADOWSKA','5783101032',NULL,'karolpufal@gmail.com','telefon','Jan Kowalski','nowy',NULL,NULL,'2026-02-18 12:03:07','2026-02-18 12:14:23',2,'Niski',NULL,NULL,15,'2026-02-18 13:14:23',2,2,NULL,NULL,NULL,NULL,'','82-300','Elbląg','ul. Ułańska','13',NULL),
(10,'Damian Szuplewski','5782068232',NULL,'marianwolski2323@gmail.com','telefon','Jan Kowalski','nowy','Zadzwonić do klienta','2026-02-19','2026-02-18 12:23:55','2026-02-18 13:00:25',2,'Średni','Kontakt z klientem','2026-02-19 12:10:00',16,'2026-02-18 14:00:25',2,2,NULL,NULL,NULL,NULL,'','82-300','Elbląg','ul. Bohaterów Monte Cassino','2a',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=latin2 COLLATE=latin2_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-21 18:51:45
